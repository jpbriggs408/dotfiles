...
# Handy aliases for work machine users
...
alias pu='cd ~/development/Monorepo/tests/phpunit/ && pake unit_nosetup'
alias pus='cd ~/development/Monorepo/tests/phpunit/ && pake unit'
alias puf='cd ~/development/Monorepo/tests/phpunit/ && pake unit_nosetup "'"'"'--filter'"'"'"'
alias pusf='cd ~/development/Monorepo/tests/phpunit/ && pake unit "'"'"'--filter'"'"'"'
alias pi='cd ~/development/Monorepo/tests/phpunit/ && pake integration_nosetup'
alias pis='cd ~/development/Monorepo/tests/phpunit/ && pake integration'
alias pif='cd ~/development/Monorepo/tests/phpunit/ && pake integration_nosetup "'"'"'--filter'"'"'"'
alias pisf='cd ~/development/Monorepo/tests/phpunit/ && pake integration "'"'"'--filter'"'"'"'
alias ew='cd ~/development/Monorepo'
alias edit-profile='vi ~/.bash_profile'
alias source-profile='source ~/.bash_profile'
alias my-vertica='vsql -h vertica-prod.example.com'
